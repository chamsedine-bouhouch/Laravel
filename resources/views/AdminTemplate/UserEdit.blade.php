@extends('HomeTemplate.structure', ['activePage' => 'user-management', 'titlePage' => __('User Management')])
...
<div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('user.edit', $user->id) }}" autocomplete="off" class="form-horizontal">
            {{ csrf_field() }}
            {{method_field('PUT')}}
